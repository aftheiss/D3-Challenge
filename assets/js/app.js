var svgWidth = window.outerWidth * .75;
var svgHeight = window.outerHeight * .5;
...
var toolTip = d3.tip()
    ...
    .offset([4, -6])
    .html(function (d) {
        return (`${d.state}<b>Percentage in Poverty: ${d.poverty}<br>Healthcare: ${d.healthcare}`);
    });
